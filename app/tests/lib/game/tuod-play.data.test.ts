...
// F27 Task 1: tuod-play.data.ts now imports currentFacts from
...
describe("tuodPlay", () => {
  ...
  describe("MINUTES duration mode timer wiring", () => {
    ...
    it("submitVisit() unlocks the timer's audio synchronously", async () => {
      ...
      component.scoreInput.setValue("5");
...
describe("tuodPlay — DartBot opponent", () => {
  const BOT_REF = "bot-1";
  ...
  function botConfig(): Seated<TuodSnapshot> {
