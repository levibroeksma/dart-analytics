...
export const rulesetVersionsRelations = relations(
  rulesetVersions,
  ({ one, many }) => ({
...
export const participantTypesRelations = relations(
  participantTypes,
  ({ many }) => ({
    participants: many(participants),
  }),
...
export const exerciseStagesRelations = relations(
  exerciseStages,
  ({ one, many }) => ({
    exerciseSession: one(exerciseSessions, {
...
export const configurationTemplatesRelations = relations(
  configurationTemplates,
  ({ one }) => ({
    gameType: one(gameTypes, {
...
export const sessionWriteIdempotencyRelations = relations(
  sessionWriteIdempotency,
  ({ one }) => ({
    exerciseSession: one(exerciseSessions, {
...
export const gameTypeFeaturesRelations = relations(
  gameTypeFeatures,
  ({ one }) => ({
    gameType: one(gameTypes, {
