...
The canonical database entity reference is **`05-Database/06-Database-Specification.md`**. Migrations `0001`–`0014` and seeds `0001`–`0002` implement it.
...
| `05-Database/03-Migrations.md`             | Migration strategy and chain `0001`–`0014` (2026-07-12)           |
