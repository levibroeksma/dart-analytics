...
| `verification/0008_shanghai_capability_checks.sql` | `seeds/0008`+`0007` combined: `SHANGHAI_V1`/`RECREATIONAL`/`DETAILED_DARTS` resolves, zero undeclared `exercise_sessions` — full-table triple-count parity lives in `0007_capability_seed_checks.sql` alone (2 checks) |
