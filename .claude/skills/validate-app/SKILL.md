---
name: validate-app
description: Use before claiming any app/ change done — runs the Dart Analytics validate:app sequence (db:status, db:migrate, db:introspect, fallow gate, tests, astro check, graph refresh) and states when to also run it mid-task.
---
