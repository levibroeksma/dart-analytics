...
| `app/src/components/forms/HandednessForm.astro` | Profile-page throwing-hand picker — roving-tabindex radiogroup writing `$store.boardInput.handedness` directly; title/explanation moved into `components/ui/InfoSection.astro`, RIGHT/LEFT options laid out on one line (`flex` row, `flex-1` each) (D206, 2026-08-11; single-line + InfoSection reuse #84, 2026-08-11) | canonical |
