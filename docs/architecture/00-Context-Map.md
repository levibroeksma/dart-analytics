...
| Bug in migration chain | `05-Database/03-Migrations.md`, full chain `database/migrations/0001`–`0033`; never patch applied files | ~5.1k |
...
8. SQL migrations `0001`–`0033` and seeds
