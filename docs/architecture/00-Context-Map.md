...
| New test / test-strategy question | `07-Frontend/06-Test-Strategy.md`, `app/CLAUDE.md` | ~5.4k |
...
| Bug in migration chain | `05-Database/03-Migrations.md`, full chain `database/migrations/0001`–`0035`; never patch applied files | ~5.1k |
...
8. SQL migrations `0001`–`0035` and seeds
