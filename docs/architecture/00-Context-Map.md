...
| Bug in migration chain | `05-Database/03-Migrations.md`, full chain `database/migrations/0001`–`0043`; never patch applied files | ~9.9k |
...
8. SQL migrations `0001`–`0043` and seeds
