...
| `decisions/frontend/astro.md` | 15 decisions — .astro, component, prerender, routing, layout, cn(), props, frontmatter, PWA, manifest, icon, safe-area | canonical | ~2k |
