...
The canonical database entity reference is **`05-Database/06-Database-Specification.md`**. Migrations `0001`–`0037` and seeds `0001`–`0020` implement it.
