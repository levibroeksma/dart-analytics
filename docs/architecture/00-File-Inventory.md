...
| `decisions/database.md` | 20 decisions — schema, migration, table, column, constraint, index, view, Neon, seed (D257 general statistics views, 2026-09-06; D263 exercise-type discriminator, D266 exercise_templates.exercise_type_id backfill shape, 2026-09-10; D284 training gameplay in the read model, 2026-09-16; D288 CI-applied production migrations behind a rehearsal, D291 uq_sessions_single_active keys on COALESCE(game_type_id, exercise_type_id), 2026-09-17) | canonical | ~6.4k |
