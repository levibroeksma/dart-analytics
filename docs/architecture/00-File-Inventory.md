...
| `decisions/api.md` | 36 decisions — endpoint, contract, envelope, auth, middleware, idempotency, batch, Worker, player settings (D281 turn-less batch needs no capture pair, 2026-09-15) | canonical | ~5.7k |
