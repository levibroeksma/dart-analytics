...
| `09-training-routines.md` | Proposed architecture for training routines, exercises, exercise engines; configurable/adaptive training, extends `GameEngine`/ruleset/configuration-snapshot architecture (2026-09-01); §9/§10's `ExerciseEngine` contract and §8's `TrainingEngine` orchestration are now built — see `app/src/modules/exercise/`, `app/src/modules/training/`, `app/src/lib/exercise/`, `app/src/services/exercise-rulesets/` (D264, 2026-09-10) | canonical | ~6.3k |
...
| `decisions/database.md` | 18 decisions — schema, migration, table, column, constraint, index, view, Neon, seed (D257 general statistics views, 2026-09-06; D263 exercise-type discriminator, D266 exercise_templates.exercise_type_id backfill shape, 2026-09-10; D269 0002_default_templates.sql join-based exercise_type_id, supersedes D266's apply-order requirement, 2026-09-12) | canonical | ~5.1k |
