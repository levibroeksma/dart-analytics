...
| `decisions/database.md` | 20 decisions — schema, migration, table, column, constraint, index, view, Neon, seed (D257 general statistics views, 2026-09-06; D263 exercise-type discriminator, D266 exercise_templates.exercise_type_id backfill shape, 2026-09-10; D284 training gameplay in the read model, 2026-09-16; D288 CI-applied production migrations behind a rehearsal, D290 schema.ts the only committed introspect artifact, 2026-09-17) | canonical | ~6k |
| `decisions/api.md` | 39 decisions — endpoint, contract, envelope, auth, middleware, idempotency, batch, Worker, player settings (D283 training activity read player-scoped, terminal transition guarded in the UPDATE; D285 active-session conflict detection walks the error `cause` chain, 2026-09-16) | canonical | ~7.2k |
