...
| `decisions/api.md` | 37 decisions — endpoint, contract, envelope, auth, middleware, idempotency, batch, Worker, player settings (D282 SessionApiError carries requestId/details, 2026-09-15) | canonical | ~6.5k |
