...
| `scripts/check-plan-findings-closure.sh` | Standalone CLI (not a root gate — takes a plan file path argument): checks every `Closes FINDINGS.md F<id>` claim in a plan against the plan's own text for a matching deletion step; cannot verify the deletion targets the right block or that the plan's code is correct (F59, 2026-09-03) | canonical |
| `scripts/check-plan-findings-closure-hook.sh` | `PostToolUse` hook wrapper (wired in `.claude/settings.json` on `Write\|Edit`) filtering to `docs/superpowers/plans/*.md`: blocks (exit 2) on a closure mismatch from `check-plan-findings-closure.sh`, prints a non-blocking reminder when the plan's text names a `scripts/*.sh` path (F59, 2026-09-03) | canonical |
...
| `FINDINGS.md` | Open findings: defects and contradictions noticed but deliberately not fixed; append-then-delete, high-water-mark ids, guarded by `scripts/check-findings-log.sh` (2026-08-20); F34-F37 added from issue #169's final whole-branch review (2026-08-27); F39-F42 added from the engine-duplication-cleanup audit (2026-08-27); F54-F57 added from the DartBot phases 1-7 code review (2026-09-02); F58 added from a context-maintenance pass finding 3 plans' skipped Version History entries (2026-09-02); F45, F54-F57 closed by the DartBot setup-wiring fixes plan (2026-09-02); F9, F28, F30, F46, F51, F53 closed by the doc-only-corrections plan (2026-09-02); F44 closed by the board-dart-bull-double-checkout plan (2026-09-02); F10, F18, F21 closed by the tuod-hardening plan (2026-09-02); F32, F33 closed by the preview-seat-scoping-fixes plan (2026-09-02); F31 closed by the alpine-reactivity-fold-fixes plan (2026-09-02); F20, F34, F35, F37 closed by the scoring-stats-correctness plan (2026-09-02); F5, F38, F42, F43, F50 closed and F59 added by the process-gate-improvements plan (2026-09-02); F60 added by the play-data-lifecycle-dedup plan (2026-09-03); F15 (partial) and F58, F59 closed by the open-findings-cleanup plan (2026-09-03); F61, F62 added by the Shanghai DartBot wiring task (2026-09-03); F62 closed by the Singles Training DartBot wiring task (2026-09-03); F63 added by the score-training/121/tuod guest-opponent-slot fix (2026-09-03); F66 added by the 501 best-leg-stat task (2026-09-04); F69 added by the Shanghai hard-mode-vs-DartBot fix (2026-09-07); F70, F72 added by the 121 checkout-hint/fallow-report-line audit (2026-09-07/08); F73 added by the statistics-500/highest-checkout fix (2026-09-08); F78, F79 added by the session-repository astro-check audit (2026-09-11); F80-F84 added by the SWITCHING/DOUBLE_PATTERN engine tasks (2026-09-11); F80 closed and F85 added by the WarmUpEngine weight-generalization task (2026-09-11) | canonical | ~12.1k |
...
| `decisions/api.md` | 32 decisions — endpoint, contract, envelope, auth, middleware, idempotency, batch, Worker, player settings (D271 training-activity abandon endpoint, 2026-09-13) | canonical | ~4.5k |
