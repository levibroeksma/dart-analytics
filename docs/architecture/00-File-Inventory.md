...
| `decisions/api.md` | 38 decisions — endpoint, contract, envelope, auth, middleware, idempotency, batch, Worker, player settings (D283 training activity read player-scoped, terminal transition guarded in the UPDATE, 2026-09-16) | canonical | ~6.5k |
