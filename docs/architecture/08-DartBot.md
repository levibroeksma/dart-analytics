...
| The DartBot **write path**                                                                                                                                              | **still deferred** — `DECISIONS.md` §Deferred now reads "DartBot participants (2026-07-12)" alone, the guest half having been struck; `DARTBOT` is explicitly _refused_ at the create contract | `app/src/pages/api/sessions/types.ts`                                                                  |
