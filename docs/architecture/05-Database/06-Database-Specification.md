...
>
> Every database table, relationship, ownership rule and lifecycle described in this specification maps directly to the SQL migrations contained in the database project (`0001`–`0022`).
>
