...
| 5 | `05-Database/CHECKLIST.md` | Stale one-off tracking aid (its "files present" list predates `11-Neon-Integration.md` and the `06-Spec/` split) | **deleted** (user decision 2026-07-14: it was a temporary revision checklist that slipped through) + deregistered from `00-Context-Map.md` — done in this change, no further work |
