...
- Never modify applied migrations (`0001`–`0035`); new schema change = new numbered migration + spec update.
...
- Task branches may be worked in a git worktree under `.claude/worktrees/` or checked out directly in the main working copy; both are allowed. A worktree is cleaned up once its branch lands — a worktree left behind after its PR merges is a defect. (2026-09-17, D293, supersedes D102)
