...
- Never modify applied migrations (`0001`–`0038` is the full chain; `0038` itself is committed unapplied and is the chain head, D324, so it alone remains legitimately editable in place); new schema change = new numbered migration + spec update. (2026-09-19)
